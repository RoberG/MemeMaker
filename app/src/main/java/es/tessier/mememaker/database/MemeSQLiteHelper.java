...
public class MemeSQLiteHelper extends SQLiteOpenHelper{
    ...
    static final String CREATE_TABLE_ANNOTATIONS = "CREATE TABLE " + MemeContract.AnnotationsEntry.TABLE_NAME + " ( "+
            ...
            MemeContract.AnnotationsEntry.COLUMN_FK_MEME + " TEXT NOT NULL," +
            ...
            "FOREIGN KEY (" + MemeContract.AnnotationsEntry.COLUMN_FK_MEME + ") " +
            " REFERENCES MEMES("+ MemeContract.MemesEntry.COLUMN_ID +") );";
